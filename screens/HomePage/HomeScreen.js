...
function HomeScreen() {
  ...
  const sensors = ["Moisture", "Temperature", "EC"];
      ...
      <ScrollView style={styles.homeContainer}>
        ...
        <View style={styles.welcomeHeading}>
          <View style={styles.headingTextContainer}>
            ...
            <Text style={styles.welcomeText}>Welcome, Minh Cu Bu!</Text>
          </View>
        ...
        <View style={styles.devicesContainer}>
          ...
          <DeviceController deviceName="Lights" />
          <DeviceController deviceName="Canopy" />
        </View>
        ...
        <View style={styles.sensorsContainer}>
          ...
          <DeviceController deviceName="Moisture" />
          <DeviceController deviceName="Temperature" />
          <DeviceController deviceName="EC" />
        </View>
      </ScrollView>
    </SafeAreaView>
  );
